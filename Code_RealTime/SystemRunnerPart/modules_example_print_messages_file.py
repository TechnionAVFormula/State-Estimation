...
class FormulaProtoPrinter:
    ...
    def print_message(self, msg):
        msg_str = json_format.MessageToDict(msg)  # text_format.MessageToString(msg, message_formatter=self._message_formatter)
...
def main():
    ...
    client = FormulaClient(ClientSource.PERCEPTION, 
        read_from_file=args.message_file, write_to_file=os.devnull)
